...
<Accordion title="Why did I build the plugin?" id="why-built">
...
<Accordion title="Is this plugin affiliated with Better Auth?" id="official-affiliation">
...
<Accordion title="Why did I change the plugin name?" id="new-name">
