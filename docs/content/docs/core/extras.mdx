      ...
      schema: {
        invite: {
          ...
          fields: {
            ...
            createdAt: "customtest",
          }
        },
        inviteUse: {
          modelName: "customInviteUse",
          fields: {
            inviteId: "inviteId_test" // This can be whatever you want
          }
        }
      }
    })
...
The `acceptInviteCallback` route uses an optional session, which allows invites to be accepted whether or not the user is logged in:
