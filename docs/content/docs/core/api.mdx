...
<Callout type="warn" title="Deprecated">
  This endpoint is deprecated. Prefer [Accept Invite](#accept-invite).
</Callout>
...
<APIMethod path="/invite/get" method="GET" optionalSession note="For private invites, the requester must match the invite email, unless `allowDangerousGetInvite` is set to true.">
```ts
type getInvite = {
  /**
