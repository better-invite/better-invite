...
We only support the latest version of Better Invite.
...
1. Do not disclose the vulnerability publicly until it has been addressed by our
   team.
2. Email your findings to `security@better-invite.com` Include:
...
4. If the issue is confirmed, we will release a patch as soon as possible (usually around in 7 days).
   You'll be credited in the patch, unless you'd prefer to stay anonymous
